        ...
        <div className="navbar bg-base-100 shadow-lg shadow-sky-400  mx-auto rounded-lg border w-[85%] border-sky-400">
          ...
          <div className="navbar-end">
           ...
           : <div className="space-x-5 ">
              ...
              to={"/login"}
              href="#_"
              class="rounded px-5 py-1.5 overflow-hidden group bg-blue-500 relative hover:bg-gradient-to-r hover:from-sky-500 hover:to-indigo-400 text-white hover:ring-indigo-600 transition-all ease-out duration-300"
            >
            ...
            <Link
              to={"/register"}
              href="#_"
              class="rounded px-5 py-1.5 overflow-hidden group bg-blue-500 relative hover:bg-gradient-to-r hover:from-sky-500 hover:to-indigo-400 text-white hover:ring-indigo-400 transition-all ease-out duration-300"
            >
              <span class="absolute right-0 w-8 h-32 -mt-12 transition-all duration-1000 transform translate-x-12 bg-white opacity-10 rotate-12 group-hover:-translate-x-40 ease"></span>
